...
import Foto from '../../img/about.png'
...
export default function About() {
    return (
        <div className='bg-[#403C3B]'>
            <div className='p-8  relative top-[15vh]'>
                <div style={{ backgroundImage: `url(${Foto})`, height: `80vh`, width: `100%`, backgroundSize: 'cover' }} className='px-10 rounded-xl flex justify-between items-center'>
