...
export default function Fishs() {
  ...
  const fishs = [
    ...
    { id: crypto.randomUUID(), img: cold2, nameFood: 'Тунец', weight: '400гр', about: 'Тунец в соевом соусе', price: '50c' },
    { id: crypto.randomUUID(), img: cold3, nameFood: 'Окунь', weight: '250гр', about: 'Окунь с овощами', price: '28c' },
    { id: crypto.randomUUID(), img: cold4, nameFood: 'Форель', weight: '330гр', about: 'Запеченный форель', price: '46c' },
    { id: crypto.randomUUID(), img: cold5, nameFood: 'Скумбрия', weight: '240гр', about: 'Скумбрия в томатном соусе', price: '37c' },
    { id: crypto.randomUUID(), img: cold6, nameFood: 'Судак', weight: '400гр', about: 'Жареный судак с лимоном', price: '29c' },
    { id: crypto.randomUUID(), img: cold8, nameFood: 'Минтай', weight: '330гр', about: 'Жареный минтай', price: '42c' },
  ];
