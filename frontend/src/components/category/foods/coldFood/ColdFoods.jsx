...
export default function ColdFoods() {
  ...
  const coldFoods = [
    ...
    { id: crypto.randomUUID(), img: cold4, nameFood: 'Брускетта', weight: '330гр', about: 'Хрустящая, ароматная, сочная брускетта.', price: '35c' },
    { id: crypto.randomUUID(), img: cold5, nameFood: 'Коул Слоу', weight: '240гр', about: 'Свежий, хрустящий, сбалансированный Коул Слоу.', price: '35c' },
    { id: crypto.randomUUID(), img: cold6, nameFood: 'Хумус', weight: '400гр', about: 'Нежный, ароматный, питательный хумус.', price: '35c' },
    { id: crypto.randomUUID(), img: cold8, nameFood: 'Капрезе', weight: '330гр', about: 'Свежий, летний, простой капрезе.', price: '35c' },
  ];
